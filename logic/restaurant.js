...
var listings = {
    ...
    getOrders: function (req) {
        ...
        orderTable.find({
                ...
                "address combined_id dishes_ordered source delivery customer_name created_time log " +
        ...
        restaurantTable.findOne({name: req.params.name}, "nomnom_username nomnom_password servicing_restaurant",
            ...
            if(restaurant){
                ...
                orderTable.find({
                    ...
                    "address dishes_ordered source full_order payment_mode delivery" +
    ...
    getUnpaidOrders: function (req) {
        ...
        orderTable.find({
            ...
            "address dishes_ordered combined_id full_order source payment_mode delivery_price_recieved" +
    ...
    getOrder: function (req) {
        ...
        orderTable.findOne({_id: req.query.order_id},
            "address delivery full_order dishes_ordered combined_id city source locality area rejection_reason status  payment_mode payment_status"
            , function (err, order) {
                if (!err) {
                    def.resolve(order);
                } else {
